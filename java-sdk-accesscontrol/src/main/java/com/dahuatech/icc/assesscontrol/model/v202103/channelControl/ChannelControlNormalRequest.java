 ...
 * @author 237417
 */
public class ChannelControlNormalRequest extends AbstractIccRequest<ChannelControlNormalResponse> {

    /** 门通道编码 */
    private List<String> channelCodeList;

    public ChannelControlNormalRequest(Builder builder) throws ClientException {
    ...
    @Override
    public Class<ChannelControlNormalResponse> getResponseClass() {
        return ChannelControlNormalResponse.class;
    }
    ...
    public static class Builder {
        ...
        public ChannelControlNormalRequest build() throws ClientException {
            return new ChannelControlNormalRequest(this);
        }
    }
}
