...
import cn.iotwasu.hutool.crypto.symmetric.SymmetricAlgorithm;
...
public class KeyUtil {
  ...
  public static KeyPair generateKeyPair(
      String algorithm, byte[] seed, AlgorithmParameterSpec param) {
   ...
   */
  public static KeyPair generateKeyPair(
      String algorithm, int keySize, byte[] seed, AlgorithmParameterSpec... params) {
   ...
   */
  public static KeyPair generateKeyPair(
      String algorithm, int keySize, SecureRandom random, AlgorithmParameterSpec... params) {
    algorithm = getAlgorithmAfterWith(algorithm);
   ...
   *     FileUtil#getInputStream(java.io.File)} 读取
   * @param password 密码
   ...
   * see: http://snowolf.iteye.com/blog/391931
   *
   * @param in {@link InputStream} 如果想从文件读取.cer文件，使用 {@link FileUtil#getInputStream(java.io.File)}
   *     读取
   * @param password 密码
   * @param alias 别名
   * @return {@link KeyStore}
   ...
   *
   * @param publicKey {@link
   *     PublicKey}，必须为org.bouncycastle.jcajce.provider.asymmetric.ec.BCECPublicKey
   * @return 压缩得到的X
   * @since 4.4.4
   */
