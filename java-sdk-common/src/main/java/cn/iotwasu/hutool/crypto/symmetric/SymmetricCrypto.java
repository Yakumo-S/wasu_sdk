package cn.iotwasu.hutool.crypto.symmetric;
...
import cn.iotwasu.hutool.crypto.KeyUtil;
import cn.iotwasu.hutool.crypto.Padding;
...
public class SymmetricCrypto implements Serializable {
   ...
   *
   * <p>在{@link Padding#ZeroPadding} 模式下，且数据长度不是blockSize的整数倍才有效，否则返回原数据
   *
   * <p>见：https://blog.csdn.net/OrangeJack/article/details/82913804
   *
   * @param data 数据
   * @param blockSize 块大小
