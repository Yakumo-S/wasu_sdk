...
import cn.iotwasu.hutool.core.codec.BCD;
...
public abstract class AbstractAsymmetricCrypto<T extends AbstractAsymmetricCrypto<T>>
   ...
   */
  public byte[] encrypt(
      String data, String charset, KeyType keyType) {
   ...
   */
  public byte[] encrypt(
      String data, Charset charset, KeyType keyType) {
    return encrypt(StrUtil.bytes(data, charset), keyType);
  }
   ...
   */
  public String encryptHex(
      InputStream data, KeyType keyType) {
    return HexUtil.encodeHexStr(encrypt(data, keyType));
  }
  ...
  public String encryptBcd(
      String data, KeyType keyType, Charset charset) {
