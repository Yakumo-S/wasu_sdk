package cn.iotwasu.hutool.core.map;

import cn.iotwasu.hutool.core.convert.Convert;
import cn.iotwasu.hutool.core.getter.OptNullBasicTypeFromObjectGetter;
import cn.iotwasu.hutool.core.util.ArrayUtil;
import cn.iotwasu.hutool.core.util.BooleanUtil;
import cn.iotwasu.hutool.core.util.ClassLoaderUtil;
 ...
 * @since 3.2.0
 */
public class MapProxy extends OptNullBasicTypeFromObjectGetter<Object>
    implements Map<Object, Object>, InvocationHandler, Serializable {
  ...
  public <T> T toProxyBean(Class<T> interfaceClass) {
    return (T)
        Proxy.newProxyInstance(
            ClassLoaderUtil.getClassLoader(), new Class<?>[] {interfaceClass}, this);
  }
}
