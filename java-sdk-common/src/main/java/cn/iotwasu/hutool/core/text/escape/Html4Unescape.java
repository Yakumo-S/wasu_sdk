package cn.iotwasu.hutool.core.text.escape;

import cn.iotwasu.hutool.core.text.replacer.LookupReplacer;
import cn.iotwasu.hutool.core.text.replacer.ReplacerChain;
...
public class Html4Unescape extends ReplacerChain {
  protected static final String[][] BASIC_UNESCAPE =
      InternalEscapeUtil.invert(Html4Escape.BASIC_ESCAPE);
