...
import cn.iotwasu.hutool.core.exceptions.ValidateException;
...
public class Validator {
  ...
  public static <T extends CharSequence> T validateMatchRegex(
      String regex, T value, String errorMsg) throws ValidateException {
  ...
  public static <T extends CharSequence> T validateGeneral(
      T value, int min, int max, String errorMsg) throws ValidateException {
  ...
  public static boolean isLetter(CharSequence value) {
    return StrUtil.isAllCharMatch(
        value,
        new cn.iotwasu.hutool.core.lang.Matcher<Character>() {
          @Override
