package cn.iotwasu.hutool.core.io.file;

import cn.iotwasu.hutool.core.date.DateUnit;
...
public class Tailer implements Serializable {
   ...
   */
  public Tailer(
      File file, Charset charset, LineHandler lineHandler, int initReadLine, long period) {
    checkFile(file);
