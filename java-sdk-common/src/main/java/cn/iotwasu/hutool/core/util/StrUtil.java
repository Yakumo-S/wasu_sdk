package cn.iotwasu.hutool.core.util;

import cn.iotwasu.hutool.core.comparator.VersionComparator;
...
import cn.iotwasu.hutool.core.lang.func.Func1;
import cn.iotwasu.hutool.core.text.StrBuilder;
import cn.iotwasu.hutool.core.text.StrFormatter;
import cn.iotwasu.hutool.core.text.StrSpliter;
import cn.iotwasu.hutool.core.text.TextSimilarity;
...
public class StrUtil {
  ...
  public static int lastIndexOf(
      final CharSequence str, final CharSequence searchStr, int fromIndex, boolean ignoreCase) {
    if (str == null || searchStr == null) {
      return INDEX_NOT_FOUND;
    }
    if (fromIndex < 0) {
   ...
   */
  public static String replace(
      CharSequence str, Pattern pattern, Func1<java.util.regex.Matcher, String> replaceFun) {
   ...
   */
  public static String replace(
      CharSequence str, String regex, Func1<java.util.regex.Matcher, String> replaceFun) {
  ...
  public static String move(CharSequence str, int startInclude, int endExclude, int moveLength) {
    ...
    if (moveLength > 0) {
      ...
      strBuilder
          .append(str.subSequence(0, startInclude)) //
      ...
      strBuilder
          .append(str.subSequence(0, startAfterMove)) //
          .append(str.subSequence(startInclude, endExclude)) //
