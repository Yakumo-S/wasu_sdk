...
import cn.iotwasu.hutool.core.collection.IterUtil;
...
public class ArrayUtil {
  ...
  public static <T> Object insert(Object array, int index, T... newElements) {
    ...
    final T[] result =
        newArray(array.getClass().getComponentType(), Math.max(len, index) + newElements.length);
  ...
  public static <T> T[] reverse(
      final T[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (isEmpty(array)) {
      return array;
    }
