package cn.iotwasu.hutool.core.bean;

import cn.iotwasu.hutool.core.bean.copier.BeanCopier;
import cn.iotwasu.hutool.core.bean.copier.CopyOptions;
import cn.iotwasu.hutool.core.bean.copier.ValueProvider;
...
public class BeanUtil {
  ...
  public static Map<String, PropertyDescriptor> getPropertyDescriptorMap(
    ...
    Map<String, PropertyDescriptor> map =
        BeanInfoCache.INSTANCE.getPropertyDescriptorMap(clazz, ignoreCase);
    if (null == map) {
   ...
   * 如果isSimple为{@code false}，则只匹配类名而忽略包名，例如：com.wasu.hutool.TestEntity只匹配TestEntity<br>
   * 如果isSimple为{@code
   * true}，则匹配包括包名的全类名，例如：com.wasu.hutool.TestEntity匹配com.wasu.hutool.TestEntity
   *
   * @param bean Bean
