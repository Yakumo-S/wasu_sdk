...
import cn.iotwasu.hutool.core.map.TableMap;
...
public class TypeUtil {
   ...
   * @since 4.5.7
   */
  public static Type[] getActualTypes(
      Type actualType, Class<?> typeDefineClass, Type... typeVariables) {
