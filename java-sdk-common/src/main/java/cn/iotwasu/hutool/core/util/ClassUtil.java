...
import cn.iotwasu.hutool.core.convert.BasicType;
...
import cn.iotwasu.hutool.core.lang.ClassScanner;
import cn.iotwasu.hutool.core.lang.Filter;
import cn.iotwasu.hutool.core.lang.Singleton;
...
public class ClassUtil {
  ...
  public static Method getDeclaredMethod(
      Class<?> clazz, String methodName, Class<?>... parameterTypes) throws SecurityException {
  ...
  public static <T> T invoke(
      String className, String methodName, boolean isSingleton, Object... args) {
    ...
    try {
      ...
      if (isStatic(method)) {
        ...
        return ReflectUtil.invoke(
            isSingleton ? Singleton.get(clazz) : clazz.newInstance(), method, args);
      }
    } catch (Exception e) {
