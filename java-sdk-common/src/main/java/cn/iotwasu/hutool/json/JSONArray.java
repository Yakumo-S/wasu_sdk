...
import cn.iotwasu.hutool.core.collection.ArrayIter;
...
public class JSONArray extends JSONGetter<Integer> implements JSON, List<Object>, RandomAccess {
   ...
   *
   * @param value 值，可以是： Boolean, Double, Integer, JSONArray, JSONObject, Long, or String, or the
   *     JSONNull.NULL。
   * @return this.
   */
  ...
  private void init(Object source) throws JSONException {
    ...
    if (null != serializer
        && JSONArray.class.equals(TypeUtil.getTypeArgument(serializer.getClass()))) {
      // 自定义序列化
