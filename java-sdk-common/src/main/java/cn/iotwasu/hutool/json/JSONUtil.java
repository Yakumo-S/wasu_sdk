...
import cn.iotwasu.hutool.json.serialize.JSONArraySerializer;
import cn.iotwasu.hutool.json.serialize.JSONDeserializer;
...
public final class JSONUtil {
  ...
  public static <T> T toBean(
      String jsonString, TypeReference<T> typeReference, boolean ignoreError) {
   ...
   *
   * <ul>
   *   <li><code>null</code> =》 <code>JSONNull.NULL</code>
   *   <li>array or collection =》 JSONArray
   *   <li>map =》 JSONObject
   *   <li>standard property (Double, String, et al) =》 原对象
   *   <li>来自于java包 =》 字符串
   *   <li>其它 =》 尝试包装为JSONObject，否则返回<code>null</code>
   * </ul>
   *
   * @param object 被包装的对象
