...
import cn.iotwasu.hutool.core.convert.ConvertException;
...
public class JSONConverter implements Converter<JSON> {
  ...
  protected static <T> T jsonConvert(Type targetType, Object value, boolean ignoreError)
    ...
    if (null == targetValue && false == ignoreError) {
      ...
      throw new ConvertException(
          ...
          value,
          ObjectUtil.defaultIfNull(TypeUtil.getClass(targetType), targetType));
    }
