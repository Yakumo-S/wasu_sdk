package cn.iotwasu.hutool.log;

import cn.iotwasu.hutool.core.io.resource.ResourceUtil;
import cn.iotwasu.hutool.core.lang.caller.CallerUtil;
import cn.iotwasu.hutool.log.dialect.commons.ApacheCommonsLogFactory;
import cn.iotwasu.hutool.log.dialect.console.ConsoleLogFactory;
import cn.iotwasu.hutool.log.dialect.jboss.JbossLogFactory;
import cn.iotwasu.hutool.log.dialect.jdk.JdkLogFactory;
import cn.iotwasu.hutool.log.dialect.log4j.Log4jLogFactory;
import cn.iotwasu.hutool.log.dialect.log4j2.Log4j2LogFactory;
import cn.iotwasu.hutool.log.dialect.slf4j.Slf4jLogFactory;
import cn.iotwasu.hutool.log.dialect.tinylog.TinyLogFactory;
import java.net.URL;
...
public abstract class LogFactory {
   ...
   * 决定日志实现
   *
   * <p>依次按照顺序检查日志库的jar是否被引入，如果未引入任何日志库，则检查ClassPath下的logging.properties，存在则使用JdkLogFactory，否则使用ConsoleLogFactory
   *
   * @see Slf4jLogFactory
   * @see Log4j2LogFactory
   * @see Log4jLogFactory
