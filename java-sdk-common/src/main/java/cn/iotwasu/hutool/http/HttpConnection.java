...
import cn.iotwasu.hutool.http.ssl.AndroidSupportSSLFactory;
import cn.iotwasu.hutool.http.ssl.SSLSocketFactoryBuilder;
import cn.iotwasu.hutool.http.ssl.TrustAnyHostnameVerifier;
...
public class HttpConnection {
   ...
   */
  public HttpConnection setHttpsInfo(HostnameVerifier hostnameVerifier, SSLSocketFactory ssf)
    ...
    if (conn instanceof HttpsURLConnection) {
      ...
      httpsConn.setHostnameVerifier(
          null != hostnameVerifier ? hostnameVerifier : new TrustAnyHostnameVerifier());
      if (null == ssf) {
        try {
  ...
  private HttpURLConnection openHttp() throws IOException {
    ...
    if (false == conn instanceof HttpURLConnection) {
      ...
      throw new HttpException(
          "'{}' is not a http connection, make sure URL is format for http.",
