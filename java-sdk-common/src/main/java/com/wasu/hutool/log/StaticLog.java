...
import com.wasu.hutool.core.lang.caller.CallerUtil;
...
public final class StaticLog {
   ...
   * @param arguments 变量对应的参数
   */
  public static void trace(com.wasu.hutool.log.Log log, String format, Object... arguments) {
   ...
   * @param arguments 变量对应的参数
   */
  public static void debug(com.wasu.hutool.log.Log log, String format, Object... arguments) {
   ...
   * @param arguments 变量对应的参数
   */
  public static void info(com.wasu.hutool.log.Log log, String format, Object... arguments) {
   ...
   * @param arguments 变量对应的参数
   */
  public static void warn(com.wasu.hutool.log.Log log, String format, Object... arguments) {
  ...
  public static void warn(
      com.wasu.hutool.log.Log log, Throwable e, String format, Object... arguments) {
   ...
   * @param e 需在日志中堆栈打印的异常
   */
  public static void error(com.wasu.hutool.log.Log log, Throwable e) {
   ...
   * @param arguments 变量对应的参数
   */
  public static void error(com.wasu.hutool.log.Log log, String format, Object... arguments) {
   ...
   * @return Log
   */
  public static com.wasu.hutool.log.Log get(Class<?> clazz) {
   ...
   * @return Log
   */
  public static com.wasu.hutool.log.Log get(String name) {
