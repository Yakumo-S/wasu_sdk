...
import com.wasu.hutool.log.dialect.jboss.JbossLogFactory;
...
public abstract class LogFactory {
  ...
  /** 日志对象缓存 */
  private Map<Object, com.wasu.hutool.log.Log> logCache;
   ...
   * @return 日志对象
   */
  public com.wasu.hutool.log.Log getLog(String name) {
    com.wasu.hutool.log.Log log = logCache.get(name);
    if (null == log) {
      log = createLog(name);
   ...
   * @return 日志对象
   */
  public com.wasu.hutool.log.Log getLog(Class<?> clazz) {
    com.wasu.hutool.log.Log log = logCache.get(clazz);
    if (null == log) {
      log = createLog(clazz);
   ...
   * @return 日志对象
   */
  public abstract com.wasu.hutool.log.Log createLog(String name);
   ...
   * @return 日志对象
   */
  public abstract com.wasu.hutool.log.Log createLog(Class<?> clazz);
