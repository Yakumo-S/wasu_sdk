package com.wasu.hutool.crypto;
...
import com.wasu.hutool.core.util.IdUtil;
...
public final class SecureUtil {
   ...
   * </pre>
   */
  public static final int DEFAULT_KEY_SIZE = com.wasu.hutool.crypto.KeyUtil.DEFAULT_KEY_SIZE;
  ...
  public static SecretKey generateKey(String algorithm) {
    return com.wasu.hutool.crypto.KeyUtil.generateKey(algorithm);
  }
  ...
  public static SecretKey generateKey(String algorithm, int keySize) {
    return com.wasu.hutool.crypto.KeyUtil.generateKey(algorithm, keySize);
  }
  ...
  public static SecretKey generateKey(String algorithm, byte[] key) {
    return com.wasu.hutool.crypto.KeyUtil.generateKey(algorithm, key);
  }
  ...
  public static SecretKey generateDESKey(String algorithm, byte[] key) {
    return com.wasu.hutool.crypto.KeyUtil.generateDESKey(algorithm, key);
  }
  ...
  public static SecretKey generatePBEKey(String algorithm, char[] key) {
    return com.wasu.hutool.crypto.KeyUtil.generatePBEKey(algorithm, key);
  }
  ...
  public static SecretKey generateKey(String algorithm, KeySpec keySpec) {
    return com.wasu.hutool.crypto.KeyUtil.generateKey(algorithm, keySpec);
  }
  ...
  public static PrivateKey generatePrivateKey(String algorithm, byte[] key) {
    return com.wasu.hutool.crypto.KeyUtil.generatePrivateKey(algorithm, key);
  }
  ...
  public static PrivateKey generatePrivateKey(String algorithm, KeySpec keySpec) {
    return com.wasu.hutool.crypto.KeyUtil.generatePrivateKey(algorithm, keySpec);
  }
  ...
  public static PrivateKey generatePrivateKey(KeyStore keyStore, String alias, char[] password) {
    return com.wasu.hutool.crypto.KeyUtil.generatePrivateKey(keyStore, alias, password);
  }
  ...
  public static PublicKey generatePublicKey(String algorithm, byte[] key) {
    return com.wasu.hutool.crypto.KeyUtil.generatePublicKey(algorithm, key);
  }
  ...
  public static PublicKey generatePublicKey(String algorithm, KeySpec keySpec) {
    return com.wasu.hutool.crypto.KeyUtil.generatePublicKey(algorithm, keySpec);
  }
  ...
  public static KeyPair generateKeyPair(String algorithm) {
    return com.wasu.hutool.crypto.KeyUtil.generateKeyPair(algorithm);
  }
  ...
  public static KeyPair generateKeyPair(String algorithm, int keySize) {
    return com.wasu.hutool.crypto.KeyUtil.generateKeyPair(algorithm, keySize);
  }
  ...
  public static KeyPair generateKeyPair(String algorithm, int keySize, byte[] seed) {
    return com.wasu.hutool.crypto.KeyUtil.generateKeyPair(algorithm, keySize, seed);
  }
  ...
  public static KeyPair generateKeyPair(String algorithm, AlgorithmParameterSpec params) {
    return com.wasu.hutool.crypto.KeyUtil.generateKeyPair(algorithm, params);
  }
  ...
  public static KeyPair generateKeyPair(
      String algorithm, byte[] seed, AlgorithmParameterSpec params) {
    return com.wasu.hutool.crypto.KeyUtil.generateKeyPair(algorithm, seed, params);
  }
  ...
  public static String getAlgorithmAfterWith(String algorithm) {
    return com.wasu.hutool.crypto.KeyUtil.getAlgorithmAfterWith(algorithm);
  }
   ...
   * @since 4.4.1
   */
  public static String generateAlgorithm(
      AsymmetricAlgorithm asymmetricAlgorithm, DigestAlgorithm digestAlgorithm) {
  ...
  public static KeyStore readJKSKeyStore(InputStream in, char[] password) {
    return com.wasu.hutool.crypto.KeyUtil.readJKSKeyStore(in, password);
  }
  ...
  public static KeyStore readKeyStore(String type, InputStream in, char[] password) {
    return com.wasu.hutool.crypto.KeyUtil.readKeyStore(type, in, password);
  }
  ...
  public static Certificate readX509Certificate(InputStream in, char[] password, String alias) {
    return com.wasu.hutool.crypto.KeyUtil.readX509Certificate(in, password, alias);
  }
  ...
  public static Certificate readX509Certificate(InputStream in) {
    return com.wasu.hutool.crypto.KeyUtil.readX509Certificate(in);
  }
  ...
  public static Certificate readCertificate(
    ...
    return com.wasu.hutool.crypto.KeyUtil.readCertificate(type, in, password, alias);
  }
  ...
  public static Certificate readCertificate(String type, InputStream in) {
    return com.wasu.hutool.crypto.KeyUtil.readCertificate(type, in);
  }
  ...
  public static Sign sign(
      SignAlgorithm algorithm, String privateKeyBase64, String publicKeyBase64) {
  ...
  public static String signParams(
    ...
    String paramsStr =
        MapUtil.join(MapUtil.sort(params), separator, keyValueSeparator, isIgnoreNull);
