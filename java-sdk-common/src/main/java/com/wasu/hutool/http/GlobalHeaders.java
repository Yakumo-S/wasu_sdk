...
public enum GlobalHeaders {
  ...
  public GlobalHeaders putDefault(boolean isReset) {
    ...
    // header(Header.CONTENT_TYPE, ContentType.FORM_URLENCODED.toString(CharsetUtil.CHARSET_UTF_8),
    // true);
    header(
        Header.USER_AGENT,
        "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.142 Safari/537.36 wasuIot",
        true);
    return this;
  }
