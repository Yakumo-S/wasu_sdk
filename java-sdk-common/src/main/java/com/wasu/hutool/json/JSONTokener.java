...
public class JSONTokener {
  ...
  /**
   * 获得下一个值，值类型可以是Boolean, Double, Integer, JSONArray, JSONObject, Long, or String, or the
   * JSONObject.NULL
   *
   * @throws JSONException 语法错误
   * @return Boolean, Double, Integer, JSONArray, JSONObject, Long, or String, or the
   *     JSONObject.NULL
   */
   ...
   * is not found, no characters are skipped. 在遇到指定字符前，跳过其它字符。如果字符未找到，则不跳过任何字符。
   *
   * @param to 需要定位的字符
