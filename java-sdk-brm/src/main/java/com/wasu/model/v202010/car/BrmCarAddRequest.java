 ...
 */
public class BrmCarAddRequest extends AbstractIccRequest<BrmCarAddResponse> {
  ...
  public BrmCarAddRequest() throws ClientException {
    super(BrmConstant.url(BrmConstant.BRM_URL_CAR_ADD_POST), Method.POST);
  }

  private BrmCarAddRequest(Builder builder) throws ClientException {
    super(BrmConstant.url(BrmConstant.BRM_URL_CAR_ADD_POST), Method.POST);
  ...
  @Override
  public Class<BrmCarAddResponse> getResponseClass() {
    return BrmCarAddResponse.class;
  }
  ...
  public static class Builder {
    ...
    public BrmCarAddRequest build() throws ClientException {
      return new BrmCarAddRequest(this);
    }
  }
}
