...
/**
 * 主要针对DSS-H8900-SDK-20200111版本(v3.1.4)\02-接口文档\09-客流子系统接口文档
 * <p>
 * 仅展示部分接口的调用，其他雷同
 * <p>
 * url参数也可以传全路径
 ...
 * @since 2021-05-19
 */
public class H8900_09_statistics_Test {
     ...
     */
    @Test public void h8900_09_127_statistics_list() throws ClientException {
        IClient client = new DefaultClient(host, username, password);
        GeneralRequest request = new GeneralRequest("/CardSolution/statistics/regionConfig/list", Method.POST);
