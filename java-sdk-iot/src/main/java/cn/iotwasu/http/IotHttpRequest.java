...
import cn.iotwasu.hutool.http.HttpStatus;
...
public class IotHttpRequest extends AbstractHttpRequest {
   ...
   */
  public IotHttpRequest(String url, Method method, boolean needAuth) throws ClientException {
    this.url = url;
    this.method = method;
    this.form = new HashMap<>();
    this.header = new HashMap<>();
   ...
   * @throws ClientException 请求异常
   */
  public IotHttpRequest(String url, Method method, boolean needAuth, String body)
   ...
   * @throws ClientException 请求异常
   */
  public IotHttpRequest(String url, Method method, boolean needAuth, Map<String, Object> form)
      throws ClientException {
    this.url = url;
    this.method = method;
    this.form = form;
   ...
   * @throws ClientException 请求异常
   */
  public IotHttpRequest(String url, Method method, String body) throws ClientException {
    this.url = url;
    this.method = method;
    this.form = new HashMap<>();
    this.header = new HashMap<>();
   ...
   * @throws ClientException 请求异常
   */
  public IotHttpRequest(String url, Method method, Map<String, Object> form)
      throws ClientException {
    this.url = url;
    this.method = method;
    this.form = form;
   ...
   * @throws ClientException 请求异常
   */
  public IotHttpRequest(String url) throws ClientException {
    this.url = url;
   ...
   * @return IccHttpHttpRequest对象
   */
  public IotHttpRequest get(String url) {
    this.url = url;
    this.method = Method.GET;
    httpRequest.setUrl(url).method(method);
    return this;
   ...
   * @return IccHttpHttpRequest对象
   */
  public IotHttpRequest body(String body) {
    this.body = body;
   ...
   * @return IccHttpHttpRequest对象
   */
  public IotHttpRequest header(String name, String value) {
   ...
   * @return IccHttpHttpRequest对象
   */
  public IotHttpRequest form(String name, Object value) {
    form.put(name, value);
   ...
   * @return IccHttpHttpRequest对象
   */
  public IotHttpRequest form(Map<String, Object> formParam) {
  ...
  @Override
  HttpRequest signRequest(IotHttpRequest request) {
